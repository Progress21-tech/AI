...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Insights | ProbeTech', description: 'Findings and practical advice drawn from real conversations with business owners.', type: 'website' },
};
...
export default async function InsightsPage({ searchParams }: { searchParams: { category?: string; page?: string } }) {
