...
export default async function WorkPage({ searchParams }: { searchParams: { service?: string } }) {
  ...
  return <><SiteHeader /><main className="mx-auto max-w-6xl px-6 py-16 sm:py-24">
    <div className="max-w-3xl"><p className="text-xs font-semibold uppercase tracking-[.16em] text-subtle">Work</p><h1 className="mt-3 text-4xl font-semibold leading-tight tracking-tight sm:text-5xl">Things we’ve built.</h1></div>
