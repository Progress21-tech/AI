...
export class FallbackProvider implements AIProvider {
  async generateAgentResponse(input: GenerateAgentInput): Promise<AgentModelResponse> {
    ...
    if (context.includes("employees") || context.includes("staff")) {
    ...
    } else if (context.includes("whatsapp") || context.includes("task")) {
      ...
      phase = "operations";
    } else if (context.includes("quickbooks") || context.includes("excel")) {
