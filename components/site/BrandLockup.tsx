...
export function BrandLockup({ logoSrc = '/probetech-mark.svg', className = '' }: { logoSrc?: string; className?: string }) {
  return <Link href="/" aria-label="ProbeTech home" className={`group inline-flex items-center gap-2.5 text-black font-[650] transition-opacity duration-200 ease-out hover:opacity-80 motion-reduce:transition-none ${className}`}>
